...
const Sidebar = async () => {
  ...
  return (
    <aside className='w-64 bg-[#111111] text-white flex flex-col justify-between p-4 min-h-screen'>
        <section className='fixed top-[2rem]'>
            <h2 className='text-xl fontbold'>MENU</h2>
            <nav className='mt-4'>
                <ul>
                    <li className='flex items-center gap-2 p-2 hover:bg-[#171717] rounded-md cursor-pointer text-lg '>
                        <Home/> Discover
                    </li>
                    <li className='flex items-center gap-2 p-2 hover:bg-[#171717] rounded-md cursor-pointer text-lg'>
                        <TrendingUp/> Trending
            ...
            <ul className='mt-2 mb-[2rem]'>
                {[1,2,3,4,5].map(i=> (
                    <div key={i} className='flex mt-[2rem] gap-4'>
                        <img src="https://images.unsplash.com/photo-1739279479894-71d500e7886d? q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" className='h-15 w-15 bg-gray-700 rounded-md ' />
                        <div>
